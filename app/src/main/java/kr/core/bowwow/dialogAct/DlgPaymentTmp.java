...
public class DlgPaymentTmp extends BaseAct implements View.OnClickListener {
...
//                {"result":"Y","message":"성공적으로 등록 완료되었습니다.","url":""}
                ...
                if (resultData.getResult() != null) {
                    ...
                    try {
                        ...
                        Toast.makeText(DlgPaymentTmp.this, jo.getString("message"), Toast.LENGTH_SHORT).show();
                        ...
                        e.printStackTrace();
                        Toast.makeText(DlgPaymentTmp.this, getString(R.string.net_errmsg) + "\n문제 : 데이터 형태", Toast.LENGTH_SHORT).show();
                    }
...
//                {"result":"Y","message":"성공적으로 등록 완료되었습니다.","url":""}
                ...
                if (resultData.getResult() != null) {
                    ...
                    try {
                        ...
                        if (jo.getString("result").equalsIgnoreCase("Y")) {
                            if (isSubscribe) {
                                UserPref.setSubscribeState(DlgPaymentTmp.this, "Y");
                            }
                        } else {
